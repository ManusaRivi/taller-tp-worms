...
#define CODIGO_SETEAR_TIMER 0x21
#define CODIGO_SETEAR_TARGET 0x22
#define CODIGO_ESTADO_UNIRSE_PARTIDA 0x23
#define CODIGO_PARTIDA_TERMINO 0x24
#define CODIGO_CHEATS 0x25
