...
std::unique_ptr<ProjectileClient> ProjectileGenerator::get_proyectile_with_code(int proy_type,
    ...
    switch(proy_type) {
        ...
        case ProjectileType::GREEN_GRENADE:
        ...
        case ProjectileType::RED_GRENADE:
        ...
        case ProjectileType::FRAGMENT:
            return std::make_unique<Fragment>(pos_x, pos_y, angle, id);
        case ProjectileType::DYNAMITE:
            return std::make_unique<Dynamite>(pos_x, pos_y, angle, id);
        default:
