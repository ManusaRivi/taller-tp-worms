...
Rocket::Rocket(b2World& world, ProjectileType type, uint32_t id,
                float x_pos, float y_pos, int dmg, int radius,
                int fragments, float angle, float power) :
        Projectile(world, type, id, x_pos, y_pos, dmg, radius, fragments)
{
